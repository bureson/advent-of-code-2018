...
The immune system needs a **boost**: an integer which increases the attack damage of every immune system group.

In the example above, with a boost of `1570` the immune system wins with `51` units left.

Find the smallest boost with which the immune system wins. **How many units does the immune system have left** after getting the smallest boost it needs to win?
